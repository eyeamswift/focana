...
export default function FocanaLanding() {
  ...
  return (
    <div style={{ background: COLORS.warmVanilla, minHeight: "100vh", fontFamily: "'DM Sans', sans-serif", color: COLORS.warmBrown, overflowX: "hidden" }}>
      {/* Google Fonts */}
      <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@400;500;600;700;800&family=DM+Sans:wght@400;500;600;700&family=Caveat:wght@400;500;600&display=swap" rel="stylesheet" />
      ...
      <nav style={{
        ...
        <div className="section" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", height: "72px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "24px" }}>
            ...
            <button className="cta-btn" style={{ padding: "10px 24px", fontSize: "14px", animation: "none" }}>Get Early Access</button>
          </div>
        </div>
      </nav>
      ...
      <section style={{
        ...
        <StickyNote text="Stay focused! ⏱️" rotation={4} delay={600} top="25%" left="88%" size={100} />
        ...
        <div className="section" style={{ position: "relative", zIndex: 2 }}>
          <div style={{ maxWidth: "720px", margin: "0 auto", textAlign: "center" }}>
            ...
            <div style={{
              ...
              background: "white", borderRadius: "100px", padding: "8px 20px",
              border: `1px solid ${COLORS.beigeBorder}`,
              marginBottom: "28px",
              animation: "fadeUp 0.6s ease both",
            }}>
              <span style={{ width: "8px", height: "8px", borderRadius: "50%", background: "#10B981" }} />
              <span style={{ fontSize: "14px", fontWeight: 600, color: COLORS.coffeeBrown }}>
                Built by a distracted mind, for distracted minds
              </span>
            </div>

            {/* H1 — SEO Primary: "ADHD Focus Timer Desktop App" */}
            <h1 style={{
            ...
            {/* Subhead — SEO Secondary keywords */}
            <p style={{
            ...
            <div style={{ display: "flex", gap: "16px", justifyContent: "center", flexWrap: "wrap", animation: "fadeUp 0.6s ease 0.3s both" }}>
              <button className="cta-btn" style={{ fontSize: "18px", padding: "18px 40px" }}>
        ...
        <div className="section" style={{ position: "relative", zIndex: 2, textAlign: "center", maxWidth: "640px" }}>
          ...
          {!submitted ? (
            <form onSubmit={handleSubmit} style={{
              ...
              <input
                ...
                style={{
                  ...
                  padding: "16px 20px",
                  borderRadius: "12px",
                  border: `2px solid ${COLORS.coffeeBrown}44`,
              ...
              />
              <button className="cta-btn" type="submit" style={{ animation: "pulse 2.5s infinite" }}>
                Join Waitlist →
              </button>
            </form>
          ) : (
            <div style={{
              ...
              <p style={{ fontSize: "15px", color: COLORS.warmGray, marginTop: "8px" }}>
                We'll notify you the moment Focana is ready.
              </p>
            </div>
          )}
        ...
        <div className="section" style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <div style={{
              ...
              background: `linear-gradient(135deg, ${COLORS.sunshineYellow}, ${COLORS.deepAmber})`,
              display: "flex", alignItems: "center", justifyContent: "center",
              fontFamily: "'Outfit', sans-serif", fontWeight: 800, fontSize: "15px", color: "white",
            }}>F</div>
            <span style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 600, fontSize: "17px", color: COLORS.creamYellow }}>
              Focana
            </span>
          </div>
          <p style={{ fontSize: "13px", color: COLORS.warmGray }}>
            © 2026 Focana. Built with ADHD, for ADHD.
          </p>
