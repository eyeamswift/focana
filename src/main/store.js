...
const schema = {
  ...
  timerState: {
    ...
    properties: {
      ...
      pomodoroPhase: { type: 'string', default: 'idle' },
      pomodoroWorkMinutes: { type: 'number', default: 25 },
      pomodoroBreakMinutes: { type: 'number', default: 5 },
      pomodoroBreakEndsAt: { type: ['string', 'null'], default: null },
      pomodoroBreakReturnToCompact: { type: 'boolean', default: false },
      pomodoroCyclesCompleted: { type: 'number', default: 0 },
      longSessionNudgeAcknowledged: { type: 'boolean', default: false },
      longSessionNudgeSnoozeUntilElapsed: { type: ['number', 'null'], default: null },
    },
    default: {
      mode: 'freeflow',
      seconds: 0,
  ...
  focusFacts: {
    ...
    properties: {
      ...
      dailyFactId: { type: 'string', default: '' },
      impressionDateKey: { type: 'string', default: '' },
      cycleSeenFactIds: { type: 'array', default: [], items: { type: 'string' } },
      dislikedFactIds: { type: 'array', default: [], items: { type: 'string' } },
      reactions: { type: 'object', default: {} },
      emailedFactIds: { type: 'array', default: [], items: { type: 'string' } },
